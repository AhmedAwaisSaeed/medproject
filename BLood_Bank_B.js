...
class Blood_Bank_Bank extends Component {
  ...
  render(){
    ...
    return (
            <>
             ...
             <Text style={{marginLeft:90,fontStyle:"italic",fontSize:hp('3%'),fontWeight: 'bold',color:"white"}}>Blood Bank</Text>
             </View>
...
export default Blood_Bank_Bank;
