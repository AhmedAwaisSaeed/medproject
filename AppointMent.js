...
class AppointMent extends Component {
  ...
  onPressed_ConformAppointment=()=>{
    ...
    doctor : this.state.drId,
    user : this.state.userId
    
    }

    console.log("all params in appointment",allParams);



    fetch(base_url+'appointment/createappointment', {
      method: 'POST',
      headers: {
  ...
  render(){
    ...
    return (
      ...
      on_touch={this.onPressed_ConformAppointment}
        >
          <Text style={{fontSize:RFValue(16),fontWeight:"bold",color:"#fff"}}>Confirm</Text>
      </RedButton>
